...
import aurum.aurum.fluid.types.SoulFluidType;
...
public class ModFluidTypes {
    ...
    public static final DeferredHolder<FluidType, FluidType> SOUL_TYPE = REGISTRY_FLUID_TYPE.register("soul_fluid_type", () -> new SoulFluidType());
