...
public class ExtractorProtectorSlot extends Slot {
    private final AbstractExtractorMenu menu;

    public ExtractorProtectorSlot(AbstractExtractorMenu pFurnaceMenu, Container pFurnaceContainer, int pSlot, int pXPosition, int pYPosition) {
    ...
    public boolean mayPlace(ItemStack pStack) {
        return this.menu.isProtector(pStack);
    }
