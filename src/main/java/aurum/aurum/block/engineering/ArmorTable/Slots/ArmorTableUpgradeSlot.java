...
public class ArmorTableUpgradeSlot extends Slot {
    private final AbstractArmorTableMenu menu;

    public ArmorTableUpgradeSlot(AbstractArmorTableMenu pFurnaceMenu, Container pFurnaceContainer, int pSlot, int pXPosition, int pYPosition) {
