...
public class SoulModificationTableBlockEntityRenderer implements BlockEntityRenderer<SoulModificationTableBlockEntity> {
    public SoulModificationTableBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(SoulModificationTableBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
