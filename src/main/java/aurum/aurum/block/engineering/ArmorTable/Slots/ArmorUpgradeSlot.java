...
public class ArmorUpgradeSlot extends Slot {
    private final AbstractArmorTableMenu menu;

    public ArmorUpgradeSlot(AbstractArmorTableMenu pFurnaceMenu, Container pFurnaceContainer, int pSlot, int pXPosition, int pYPosition) {
